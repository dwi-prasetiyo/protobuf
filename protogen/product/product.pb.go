...
type ReduceStocksReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ProductOrders []*ProductOrder        `protobuf:"bytes,1,rep,name=productOrders,json=product_orders,proto3" json:"productOrders,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_proto_product_type_product_proto_rawDesc = "" +
	...
	"\rproductOrders\x18\x01 \x03(\v2\x1a.product.type.ProductOrderR\x0eproduct_orders\"V\n" +
	"\x11RollbackStocksReq\x12A\n" +
	"\rproductOrders\x18\x01 \x03(\v2\x1a.product.type.ProductOrderR\x0eproduct_ordersB4Z2github.com/dwi-prasetiyo/protobuf/protogen/productb\x06proto3"
